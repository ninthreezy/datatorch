  ...
  <Container mt={5}>
    <div clss="mb-3">
      ...
      <p>
        ...
        access the Website or use any of the services. If these terms and
        conditions are considered an offer by DataTorch, acceptance is expressly
      ...
      <ol>
        <li>
          ...
          <p>
            ...
            copyright or ownership in the software or any parts thereof. We do
            not claim any ownership rights to the information that you submit to
            the DataTorch application itself,
            <b>your datasets are yours</b>.
          </p>
        </li>
        <li>
          <b>Your Account and Website</b>
          <p>
        ...
        <li>
          <b>Acceptable Use of Your Account</b>
          <p>
            By accepting this Agreement, you agree not to use, encourage,
            promote, or facilitate others to use, the Website or your account in
            a way that is harmful to others ("Acceptable Use"). Examples of
            harmful use include, but are not limited to, engaging in illegal or
            fraudulent activities, infringing upon others' intellectual property
            rights, distributing harmful or offensive content that is
            defamatory, obscene, abusive, an invasion of privacy, or harassing,
            violating the security or integrity of any computer, network or
            communications system, and taxing resources with activities such as
            cryptocurrency mining. You may not conduct external scans of any
            kind against DataTorch infrastructure without written permission
            from DataTorch. Furthermore, account name squatting is prohibited by
            DataTorch. Account names on DataTorch are administered to users on a
            first-come, first-serve basis. Accordingly, account names cannot be
            held or remain inactive for future use. Any attempts to purchase,
            solicit, or sell account names in any form may result in the
            permanent suspension of the account. DataTorch reserves the right to
            remove, rename, or close inactive accounts at its discretion.
          </p>
        </li>
        <li>
          <b>Payment and Renewal for Subscriptions Purchased</b>
          <p>
            ...
            invoice. Unless you notify DataTorch before the end of the
            applicable subscription period that you want to cancel the
            subscription will renew automatically. DataTorch reserves the right
            to adjust the rate at renewal time. You authorize us to collect the
            then-applicable subscription fee using any credit card or other
        ...
        <li>
          <b>Newsletter</b>
          <p>
            By creating an account on DataTorch website you give us permission
            to add your email address to the DataTorch newsletter. You can
        ...
        <li>
          <b>Responsibility of Website Visitors</b>
          <p>
            ...
            DataTorch disclaims any responsibility for any harm resulting from
            the use by visitors of the Website, or from any downloading by those
            visitors of content there posted. You are encouraged to report any
            violations of our Acceptable Use requirements.
          </p>
        </li>
        ...
        <li>
          ...
          <p>
            ...
            DataTorch does not have any control over those non DataTorch
            websites and webpages, and is not responsible for their contents or
            their use. By linking to a non DataTorch website or webpage,
            DataTorch does not represent or imply that it endorses such website
            ...
            Trojan horses, and other harmful or destructive content. DataTorch
            disclaims any responsibility for any harm resulting from your use of
            non DataTorch websites and webpages.
          </p>
        </li>
      </ol>
    </div>
